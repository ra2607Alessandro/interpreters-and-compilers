...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.parse_if_stat = function () {
        this.eat();
        this.expect(lexer_1.TokenType.Openparen, "Condition has to be contained inside a parenthesis");
        ...
        var ELIF = this.at();
        var elif = undefined;
        if ((ELIF === null || ELIF === void 0 ? void 0 : ELIF.type) == lexer_1.TokenType.ELIF) {
            this.eat();
            this.expect(lexer_1.TokenType.Openparen, "Condition has to be contained inside a parenthesis");
            var expr_1 = this.parse_expr();
            this.expect(lexer_1.TokenType.Closeparen, "You need to close the parenthesis bro.");
            this.expect(lexer_1.TokenType.OpenBrace, "Consequence has to contained inside curly brackets");
            var consequence_1 = this.parse_consequence();
            this.expect(lexer_1.TokenType.CloseBrace, "You forgot to close the parenthesis");
            elif = {
                kind: "ElifStatement",
                condition: expr_1,
